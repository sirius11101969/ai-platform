...
const aiExecutionLayerRoutes = require('./routes/aiExecutionLayerRoutes')
...
const aiSystemHealthRoutes = require('./routes/aiSystemHealthRoutes')
const aiWorkforceRoutes = require('./routes/aiWorkforceRoutes')
const approvalCenterRoutes = require('./routes/approvalCenterRoutes')
const aiSequenceRoutes = require('./routes/aiSequenceRoutes')
const aiCheckoutRecoveryRoutes = require('./routes/aiCheckoutRecoveryRoutes')
...
const aiSecretaryRoutes = require('./routes/aiSecretaryRoutes')
...
const aiEnterpriseCoordinationRoutes = require('./routes/aiEnterpriseCoordinationRoutes')
const aiOrganizationalMemoryRoutes = require('./routes/aiOrganizationalMemoryRoutes')
const aiExecutiveUnifiedDashboardRoutes = require('./routes/aiExecutiveUnifiedDashboardRoutes')
const aiCommandCenterRoutes = require('./routes/aiCommandCenterRoutes')
...
const { startCheckoutRecoveryScheduler } = require('./services/aiCheckoutRecoveryScheduler')
...
app.use('/api/ai-checkout-recovery', aiCheckoutRecoveryRoutes)
...
app.use('/api/ai-secretary', aiSecretaryRoutes)
app.use('/api', revenueRoutes)
app.use('/api', paymentRoutes)
app.use('/api/ai', aiExecutiveBrainRoutes)
app.use('/api/ai', aiCompanySimulationRoutes)
app.use('/api/ai', aiStrategicPlanningRoutes)
app.use('/api/ai', aiEnterpriseCoordinationRoutes)
app.use('/api/ai', aiOrganizationalMemoryRoutes)
app.use('/api/ai', aiExecutiveUnifiedDashboardRoutes)
app.use('/api/ai', aiCommandCenterRoutes)
console.info('ai_revenue_engine_routes_registered', { basePath: '/api/ai/revenue-engine' })
