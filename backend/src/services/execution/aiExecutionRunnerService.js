...
async function executeJob(job) {
  ...
  if (job.job_type === aiRevenueIntelligenceService.LEAD_INTELLIGENCE_ANALYSIS_JOB_TYPE) {
    return aiRevenueIntelligenceService.executeLeadIntelligenceAnalysisJob(job)
  }
