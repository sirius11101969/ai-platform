  ...
  return {
    ...
    async query(sql, params = []) {
      ...
      if (sql.includes('INSERT INTO ai_voice_calls')) {
        const row = { id: '44444444-4444-4444-8444-444444444444', workspace_id: params[0], lead_id: params[1], sequence_id: params[2], provider: params[3], status: 'queued', phone_number: params[4], metadata: JSON.parse(params[5]), created_at: new Date().toISOString() }
