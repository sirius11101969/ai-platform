...
## AS6 Env Contract Rule
Configuration drift must be diagnosed without printing secret values.
Required signals:
- AS6_ENV_CONTRACT=PASS
...
## AS6 AEC_CHANGE_PIPELINE_CONTROLLER Rule
Required diagnostic signal: AEC_CHANGE_PIPELINE_CONTROLLER=PASS


## AS6 AEC_ROLLBACK_READINESS Rule
Required diagnostic signal: AEC_ROLLBACK_READINESS=PASS


## AS6 AEC_PRODUCTION_FREEZE_GUARD Rule
Required diagnostic signal: AEC_PRODUCTION_FREEZE_GUARD=PASS


## AS6 AEC_AUTONOMOUS_REPAIR_CONTROLLER Rule
Required diagnostic signal: AEC_AUTONOMOUS_REPAIR_CONTROLLER=PASS


## AS6 AEC_AUTONOMOUS_VALIDATION_CONTROLLER Rule
Required diagnostic signal: AEC_AUTONOMOUS_VALIDATION_CONTROLLER=PASS
