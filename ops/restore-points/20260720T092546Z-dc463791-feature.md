...
- id: 20260720T092546Z-dc463791-feature
- timestamp_utc: 20260720T092546Z
- mode: feature
- label: customizable-central-layout-v1
- branch: feat/customizable-central-layout-v1
- commit: dc4637915e2e2c3dd7734b311e68d54d389c161f
- short_commit: dc463791
- readiness: 99%
...
Safe local restore:
    ...
    ops/bin/as6-restore-to-tag AS6_RESTORE_dc463791

Direct git restore:

    git fetch origin main
    git checkout main
    git reset --hard dc4637915e2e2c3dd7734b311e68d54d389c161f
...
?? frontend/src/living/product-v2/centralWorkspaceLayout.js
?? ops/bin/as6-control-customizable-central-layout-v1
?? ops/diagnostics/as6-customizable-central-layout-v1.mjs
?? ops/restore-points/20260720T092546Z-dc463791-feature.md
