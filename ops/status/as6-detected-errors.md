...
## 20260623T102000Z detected-error
- Class: PACKAGE_LOCK_OUT_OF_SYNC
- Root cause: frontend package.json and package-lock.json were not synchronized for local vendor packages.
- Fix: V213B regenerates frontend/package-lock.json and adds package lock sync diagnostic.

## 20260623T102000Z detected-error
- Class: NPM_CI_LOCKFILE_MISMATCH
- Root cause: npm ci could not resolve framer-motion@11.18.2 and react-router-dom@6.26.2 from the prior lockfile shape.
- Fix: V213B stores local vendor dependencies as lockfile links with vendor package entries.

## 20260623T102000Z detected-error
- Class: FRONTEND_DEPENDENCY_DRIFT
- Root cause: dependency metadata drift between frontend manifest, lockfile and vendored package metadata.
- Fix: V213B adds ops/bin/as6-diagnose-package-lock-sync-v213b to detect future drift.
