...
## AS6_DONE=PRODUCTION_MISSION_SHELL_FORCE_V114B
- Root cause: V114 did not enforce production rebuild/deploy visibility.
- Added forced CSS: frontend/src/styles/as6-production-mission-shell-force.css
- Added diagnostic: ops/bin/as6-diagnose-production-mission-shell-force-v114b
- Added control: ops/bin/as6-control-production-mission-shell-force-v114b
- Added failure classes: PRODUCTION_SHELL_DEPLOYMENT_GAP, BROWSER_CACHE_VISUAL_STALE_BUNDLE, LEGACY_SIDEBAR_NOT_SUPPRESSED, SHELL_ADAPTER_NOT_VISIBLE_IN_PRODUCTION.
- Real visual migration after V114B expected: 95%.

## AS6_DONE=PRODUCTION_MISSION_CONTROL_SHELL_V114C
- Added shell: frontend/src/components/AS6ProductionMissionControlShell.jsx
- Added CSS: frontend/src/styles/as6-production-mission-control-shell.css
- Added doc: docs/AS6_REAL_PRODUCTION_MISSION_CONTROL_SHELL_V114C.md
- Real visual migration after V114C expected: 100%.
