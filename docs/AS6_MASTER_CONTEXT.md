...
CURRENT_BRANCH=main
LAST_COMMIT=97851d2e95632a030772f1c0c7022306838eeeef
LAST_COMMIT_SHORT=97851d2
LAST_COMMIT_MESSAGE=ops: add post-commit AS6 context refresh v218b
LAST_COMPLETED_STAGE=V218B
CURRENT_STAGE=V218B
NEXT_RECOMMENDED_STAGE=V218 — Design System Foundation
PROJECT_READINESS=99%
LAST_RESTORE_TAG=AS6_RESTORE_97851d2
...
## Restore Safety
- Latest restore tag: AS6_RESTORE_97851d2
- Local restore command: ops/bin/as6-restore-to-tag AS6_RESTORE_97851d2
- Remote restore command: CONFIRM_AS6_RESTORE=YES ops/bin/as6-restore-to-tag AS6_RESTORE_97851d2 --push
